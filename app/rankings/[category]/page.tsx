...
export default async function RankingsCategoryPage({
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      <h1 className="mt-2 font-display text-4xl font-black tracking-tight text-white sm:text-5xl">{CATEGORY_LABEL[params.category]} Rankings</h1>
      <p className="mt-2 text-white/50">Built from real pairwise votes — updated live.</p>
